...
//Odometrie
    ...
    #define DISTANCEWHEEL 288.8 // + => moins tourner
    #define DIAMETERWHEELD 60.6
    #define DIAMETERWHEELG 60.6 //+ => - theta
...
#define __I2CBUFFERSIZE__ 16
#define I2CBUFFERCOMMANDENB 256
